...
Button_2.Position = UDim2.new(0.0327510908, 0, 0, 0)
Button_2.Size = UDim2.new(0, 197, 0, 36)
...
local function HUCV_fake_script() -- DreckHub.Config 
...
coroutine.wrap(HUCV_fake_script)()
